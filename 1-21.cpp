...
GLvoid drawScene() //--- 콜백 함수: 그리기 콜백 함수
{
	...
	// 원근 투영
	projection2 = glm::ortho(-5.0f, 5.0f, 0.1f, 10.0f);
	projection2 = glm::translate(projection2, glm::vec3(0.0, 5.0, 0.0));
	projection2 = glm::rotate(projection2, glm::radians(y_y_rad - 15), glm::vec3(0.0, 1.0, 0.0));
	projection2 = glm::rotate(projection2, glm::radians(-30.0f), glm::vec3(1.0, 0.0, 0.0));
	...
	glViewport(800, 100, 300, 300);

	// 세 번째
	// 원근 투영
	projection3 = glm::ortho(-5.0f, 5.0f, 0.1f, 10.0f);
	projection3 = glm::translate(projection3, glm::vec3(0.0, 5.0, 0.0));
	projection3 = glm::rotate(projection3, glm::radians(y_y_rad), glm::vec3(0.0, 1.0, 0.0));
	projection3 = glm::rotate(projection3, glm::radians(-15.f), glm::vec3(0.0, 0.0, 1.0));
	projection3 = glm::rotate(projection3, glm::radians(-30.0f + 90), glm::vec3(1.0, 0.0, 0.0));
	glUniformMatrix4fv(projectionLocation, 1, GL_FALSE, &projection3[0][0]);
